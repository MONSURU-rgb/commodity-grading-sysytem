...
function CreateGrade({ opened, close, placeholder }: ModalType) {
  ...
  return (
    <div className="parameter-modal">
      <Modal
        ...
        classNames={{
          overlay: "z-[201]",
          content: "!p-[clamp(32px,2.4vw,40px)] !rounded-2xl",
        }}>
        ...
        <div className="pt-31">
          <div className="grid gap-2 mb-[clamp(30px,2.6vw,44px)]">
            ...
            <input
              ...
              className="py-18 px-[clamp(10px,0.9vw,14px)] bg-white rounded-lg !text-14 text-[#C1C2C6]"
              style={{
                boxShadow:
